...
- that the manufacturer shall have sufficient levels of access to the data relating to devices with which they are claiming equivalence41.
...
|Technical characteristics|Device 1 (under clinical evaluation)|Device 2 (marketed device)|Identified differences or conclusion that there are no differences in the characteristic|
|---|---|---|---|
...
|Description of characteristics and reference to specifying documents|Device 1|Device 2 (marketed device)|
|---|---|---|
...
|Identified differences or conclusion that there are no differences in the characteristic| | |
...
|Scientific justification why there would be no clinically significant difference in the safety and clinical performance of the device, OR a description of the impact on safety and or clinical performance| | |
|Clinically significant difference|Yes / No| |

Page 18 of 20
# 2. Clinical

|Device 1|Device 2 (marketed device)|Identified differences or conclusion that there are no differences in the characteristic|
|---|---|---|
|Same clinical condition or purpose, including similar severity and stage of disease| | |
|Same site in the body| |(The characteristic must be the same for the demonstration of equivalence)|
|Similar population, including as regards age, anatomy and physiology| | |
|Same kind of user| |(The characteristic must be the same for the demonstration of equivalence)|
|Similar relevant critical performance in view of the expected clinical effect for a specific intended purpose| | |
|Scientific justification why there would be no clinically significant difference in the safety and clinical performance of the device, OR a description of the impact on safety and or clinical performance| |Clinically significant difference|
| | |Yes / No|
